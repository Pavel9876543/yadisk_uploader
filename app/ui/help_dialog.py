...
<ol>
  <li>
    ...
    Введите OAuth-токен Яндекс.Диска в отдельное поле, нажмите
    <i>Сохранить токен</i> и при необходимости проверьте соединение.
    Токен будет сохранён в файл <code>.env</code> как <code>YANDEX_TOKEN</code>.
  </li>
